...
public final class HomepageBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView avaxTokenBalanceText;
  ...
  private HomepageBinding(@NonNull ConstraintLayout rootView, @NonNull Button SendBtn,
      @NonNull TextView avaxTokenBalanceText, @NonNull ImageView avaxlogoImageView,
      @NonNull ImageView avaxlogoImageView2, @NonNull TextView circleHeader4,
      @NonNull Button copyButton, @NonNull ImageView homePagelogo, @NonNull Button logoutButton,
      @NonNull Button receiveBtn, @NonNull Button refreshbutton,
    ...
    this.avaxTokenBalanceText = avaxTokenBalanceText;
  ...
  public static HomepageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.avaxTokenBalanceText;
      TextView avaxTokenBalanceText = ViewBindings.findChildViewById(rootView, id);
      if (avaxTokenBalanceText == null) {
        break missingId;
      }
      ...
      return new HomepageBinding((ConstraintLayout) rootView, SendBtn, avaxTokenBalanceText,
          avaxlogoImageView, avaxlogoImageView2, circleHeader4, copyButton, homePagelogo,
